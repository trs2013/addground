class ApplicationController < ActionController::Base
  ...
  def get_collections
    ...
    collections << {
      ...
      data: { behavior: 'selectable show_entries open_item feed_link countable', count_group: 'all', mark_read_message: 'Mark all items as read?' }
    }
    collections << {
      title: 'All',
      path: entries_path,
    ...
    collections << {
      ...
      data: { behavior: 'selectable show_entries open_item feed_link countable', count_group: 'all', mark_read_message: 'Mark starred items as read?' }
    }
    collections << {
      title: 'Recently Read',
      ...
      data: { behavior: 'selectable show_entries open_item feed_link', mark_read_message: 'Mark recently read items as read?' }
    }
    collections
  end
